...
//		System.out.println(pattern2+": "+denom);
		...
		double wsrm = numer/denom;
		
		SemanticRelatedness sr = new SemanticRelatedness();       		
		LDSD_combined_weighted ldsd_cw = new LDSD_combined_weighted(kb);
		double ldsd = sr.semrel(n1, n2, ldsd_cw);

		double a = 1d/2d;
		double b = 1d/2d;
		
		result = a*wsrm + b*ldsd;


//		result = wsrm + (1-wsrm)*loddo; 					
