...
package it.cnr.iasi.saks.semrel.method.asrmp_modifiedWithLODDO;
...
public class ASRMP_b extends ASRMP_Abstract {
	...
	public ASRMP_b(KnowledgeBase kb, int minLength, int maxLength, String mode, boolean acyclyc, AggregationStrategy_Interface ag) {
		super();
		this.setKb(kb);
	...
	public double semrel(Node n1, Node n2) {
		...
		paths = kb.paths(n2, n1, this.getMinLength(), this.getMaxLength(), this.getMode(), this.isAcyclyc());		
		if(paths.size() > 0)
